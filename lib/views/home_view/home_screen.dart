...
import 'package:service_provider_two/views/home_view/home_controller.dart';
import 'package:service_provider_two/views/home_view/home_screen_view.dart';
import 'package:service_provider_two/views/requests_view/request_screen_view.dart';
            ...
            items: [
              ...
              BottomNavigationBarItem(
                  icon: Padding(
                    ...
                    child: Opacity(
                      ...
                      child: SvgPicture.asset(SvgAssets.requestIcon,
                          semanticsLabel: 'requestIcon logo',
                          width: ConstantSize.homeBottomNavigationIconSize,
                          height: ConstantSize.homeBottomNavigationIconSize),
                    ),
                  ),
              ...
              BottomNavigationBarItem(
                  icon: Padding(
                    padding:const  EdgeInsets.only(bottom: ConstantSize.txtIconBottomPaddingBottomNavigation),
                    child: Opacity(
                      opacity: homeController.selectedIndex==4?ConstantSize.bottomSelectedOpacity:ConstantSize.bottomUnSelectedOpacity,
